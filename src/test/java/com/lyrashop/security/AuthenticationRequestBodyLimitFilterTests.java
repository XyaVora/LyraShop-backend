...
class AuthenticationRequestBodyLimitFilterTests {
    ...
    @ParameterizedTest
    @ValueSource(strings = {ADMIN_CATEGORY_PATH, ADMIN_CATEGORY_UPDATE_PATH, ADMIN_CATEGORY_DEACTIVATE_PATH, ADMIN_CATEGORY_ACTIVATE_PATH, ADMIN_PRODUCT_PATH, ADMIN_PRODUCT_DEACTIVATE_PATH, ADMIN_PRODUCT_ACTIVATE_PATH, ADMIN_PRODUCT_UPDATE_PATH, ADMIN_VARIANT_UPDATE_PATH, ADMIN_VARIANT_DEACTIVATE_PATH, ADMIN_VARIANT_ACTIVATE_PATH, ADMIN_VARIANT_INVENTORY_PATH, ADMIN_PRODUCT_IMAGE_PATH, CART_ITEMS_PATH, CART_ITEM_UPDATE_PATH, ORDERS_PATH, ADMIN_ORDER_STATUS_PATH, PRODUCT_REVIEWS_PATH, ADMIN_USER_STATUS_PATH, ADMIN_USER_ROLE_PATH, PROFILE_PATH})
    void appliesBusinessBodyLimitToAdminCreation(String path) throws Exception {
        ...
        MockHttpServletRequest request = request(body, body.length, path);
        if (ADMIN_PRODUCT_DEACTIVATE_PATH.equals(path) || ADMIN_PRODUCT_ACTIVATE_PATH.equals(path) || ADMIN_VARIANT_DEACTIVATE_PATH.equals(path) || ADMIN_VARIANT_ACTIVATE_PATH.equals(path) || ADMIN_VARIANT_INVENTORY_PATH.equals(path) || ADMIN_CATEGORY_DEACTIVATE_PATH.equals(path) || ADMIN_CATEGORY_ACTIVATE_PATH.equals(path)) {
            request.setMethod("PATCH");
        } else if (ADMIN_PRODUCT_UPDATE_PATH.equals(path) || ADMIN_VARIANT_UPDATE_PATH.equals(path) || CART_ITEM_UPDATE_PATH.equals(path) || ADMIN_ORDER_STATUS_PATH.equals(path) || ADMIN_USER_STATUS_PATH.equals(path) || ADMIN_USER_ROLE_PATH.equals(path) || ADMIN_CATEGORY_UPDATE_PATH.equals(path) || PROFILE_PATH.equals(path)) {
