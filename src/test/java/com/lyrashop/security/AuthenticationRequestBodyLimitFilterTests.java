...
class AuthenticationRequestBodyLimitFilterTests {
    ...
    @ParameterizedTest
    @ValueSource(strings = {ADMIN_CATEGORY_PATH, ADMIN_PRODUCT_PATH, ADMIN_PRODUCT_DEACTIVATE_PATH, ADMIN_PRODUCT_UPDATE_PATH, ADMIN_VARIANT_UPDATE_PATH, ADMIN_VARIANT_DEACTIVATE_PATH, ADMIN_VARIANT_INVENTORY_PATH, ADMIN_PRODUCT_IMAGE_PATH, CART_ITEMS_PATH, CART_ITEM_UPDATE_PATH, ORDERS_PATH, ADMIN_ORDER_STATUS_PATH})
    void appliesBusinessBodyLimitToAdminCreation(String path) throws Exception {
        ...
        } else if (ADMIN_PRODUCT_UPDATE_PATH.equals(path) || ADMIN_VARIANT_UPDATE_PATH.equals(path) || CART_ITEM_UPDATE_PATH.equals(path) || ADMIN_ORDER_STATUS_PATH.equals(path)) {
