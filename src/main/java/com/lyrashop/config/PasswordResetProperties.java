...
public record PasswordResetProperties(
    ...
    public PasswordResetProperties {
        ...
        if (requestCooldown == null || requestCooldown.isNegative() || requestCooldown.isZero()) throw new IllegalArgumentException("password reset request cooldown must be positive");
    }
}
