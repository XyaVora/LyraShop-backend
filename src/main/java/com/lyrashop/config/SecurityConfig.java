    ...
    SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/admin/categories/{id}")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/admin/categories/{id}/deactivate")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.GET, "/api/v1/admin/products")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/v1/admin/products")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/v1/admin/products/{productId}/images")
                        .hasRole(UserRole.ADMIN.name())
                        ...
                        .hasAnyRole(UserRole.CUSTOMER.name(), UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.GET, "/api/v1/admin/reviews")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/admin/reviews/{id}")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.GET, "/api/v1/admin/users")
                        .hasRole(UserRole.ADMIN.name())
                        .requestMatchers(HttpMethod.PUT, "/api/v1/admin/users/{id}/status")
                        .hasRole(UserRole.ADMIN.name())
                        .anyRequest().denyAll()
                );
